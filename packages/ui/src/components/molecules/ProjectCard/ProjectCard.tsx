    ...
    <Box className={styles.container} sx={{ ...defaultStyle, ...sx }}>
      <Card className={styles.card}>
        ...
        <CardActions className={styles.buttonsContainer}>
          {demo && <Button size='medium' variant='tertiary' endIcon={<OpenInNewIcon />}>Go to</Button>}
          {sourceCode && <Button size='medium' variant='tertiary' endIcon={<GitHubIcon />}>Code</Button>}
        </CardActions>
        <Link passHref href={link}>
